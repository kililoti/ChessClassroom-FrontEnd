        ...
        <div className="flex flex-col flex-1 overflow-hidden">
            ...
            {modalNuevaCarpeta ? (
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 disabled:opacity-40 transition-colors flex items-center gap-1 cursor-pointer"
                >
            ...
            {cargandoExplorador ? (
              ...
              carpetas.map(carpeta => (
                <button
                  ...
                  className="flex items-center gap-3 p-3 bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-300 rounded-xl transition-all text-left cursor-pointer"
                >
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 shrink-0">
            <div className="flex gap-2 justify-end">
              <button onClick={onClose} className="px-4 py-2 text-slate-600 hover:bg-slate-100 rounded-xl font-medium text-sm transition-colors cursor-pointer">
                Cancelar
              </button>
              <button
                onClick={guardar}
                disabled={!carpetaActual || loading}
                className="px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-bold text-sm transition-colors cursor-pointer disabled:cursor-not-allowed disabled:opacity-40 flex items-center gap-2"
              >
