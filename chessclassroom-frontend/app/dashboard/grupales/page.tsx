                ...
                {clasesPaginadas.map((clase) => (
                  ...
                  >
                    <div>
                      ...
                      <span className="font-bold text-lg text-slate-900 block group-hover:text-blue-600 transition-colors">{clase.nombre}</span>
        ...
        {mostrarFormulario && rolUsuario === 'profesor' && (
          <form onSubmit={handleCrearClase} className="p-6 bg-blue-50/50 border-t border-slate-200">
            ...
            <div className="flex flex-col gap-4">
              <input
                type="text"
                placeholder="Nombre del grupo (Ej: Grupo Avanzados - Tácticas)"
                value={nombreNuevo}
